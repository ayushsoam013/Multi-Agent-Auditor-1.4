...
description: Ensures that all project documentation (AGENTS.md, Gemini.md files, and other architectural docs) remains synchronized with the actual implementation of the codebase.
compatibility: opencode
---

# Documentation Maintainer

This skill ensures that all project documentation remains synchronized with the actual implementation of the codebase.
...
*   Update documentation *immediately* after a feature is completed or a bug is fixed that changes behavior.
