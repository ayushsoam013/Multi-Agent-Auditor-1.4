...
description: Specialized agent for creating new OpenCode agents. Use this agent to define new agent capabilities, create their markdown definitions in .opencode/agents/, and ensure they follow the project's agent architecture.
