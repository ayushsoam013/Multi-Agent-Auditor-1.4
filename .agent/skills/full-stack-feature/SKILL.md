...
description: Orchestrates complex features requiring changes across Agents, Backend, and Frontend. Coordination skill that triggers agent-engineering, developing-backend-app, and developing-streamlit-app in the correct order.
---
