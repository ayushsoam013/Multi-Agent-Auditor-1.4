...
@pytest.mark.asyncio
async def test_gemini_costing_returned():
    # Arrange
    with patch("app.services.gemini_gen_service.genai.Client") as MockClient:
        ...
        # This is the assertion that should fail currently
        ...
        assert "costing" in response, "Costing parameter missing from response"
        assert response["costing"] > 0, "Costing should be greater than 0"
